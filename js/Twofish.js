var Twofish=Twofish?Twofish:new function(){
...
var setW =function(a,i,w){ a.splice(i,4,(w>>>24)&0xFF,(w>>>16)&0xFF,(w>>>8)&0xFF,w&0xFF); }
var getB =function(x,n){ return (x>>>(n*8))&0xFF; }
...
{
  var dataBytes = bData.slice(0,16);
